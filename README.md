...
[![npm version](https://badge.fury.io/js/@figstranmedia/editor-pro-max-skill.svg)](https://www.npmjs.com/package/@figstranmedia/editor-pro-max-skill)
...
```bash
npm install -g @figstranmedia/editor-pro-max-skill
@figstranmedia/editor-pro-max-skill create my-video
cd my-video
npm run dev
```
